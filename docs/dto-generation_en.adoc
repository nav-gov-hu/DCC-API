...
| OECD CARF DTO
| `dto-oecd-carf-jakarta`
| Jakarta EE DTOs from the OECD Crypto-Asset Reporting Framework schemas (e.g. `CARFXML_v1.5.xsd`)

| DAC8 DTO
| `dto-dac8-jakarta`
| Jakarta EE DTOs from the CARF API (e.g. `carfapi.xsd`) schema
