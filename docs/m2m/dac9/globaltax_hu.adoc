...
* *Path:* `/dcc/m2m/v1/dac9/globaltax/report`
* *HTTP metódus:* POST
* *Fejlécek:*
...
** `report` - A jelentés fájlja (https://www.oecd.org/en/publications/globe-information-return-pillar-two-xml-schema_c594935a-en.html[GloBE Information Return (Pillar Two) XML Schema]).
