...
= DAC9 Jelentés állapot lekérdezés
...
* *Path:* `/dcc/m2m/v1/dac9/globaltax/report/{globalTaxReportId}/status`
* *HTTP metódus:* GET
* *Fejlécek:*
...
| `VALID`
| A jelentés érvényes, technikailag sikeresen feldolgozva.

| `APPROVED`
| A jelentés felhasználó által jóváhagyva. Nincs további teendő.

| `DECLINED`
| A jelentés felhasználó által elutasítva. Nincs további teendő.
