...
Contains the OECD Crypto-Asset Reporting Framework (CARF) XML schemas.
These are third-party XSD definitions published by the https://www.oecd.org/en/publications/crypto-asset-reporting-framework-xml-schema_578052ec-en/support-materials.html[OECD],
serving as the basis for content validation of DAC8 CARF reports.
